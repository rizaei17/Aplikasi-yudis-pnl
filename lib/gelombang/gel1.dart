...
class YudisGelSatu extends StatefulWidget {
  const YudisGelSatu({super.key});

  @override
  _YudisGelSatuState createState() => _YudisGelSatuState();
}

class _YudisGelSatuState extends State<YudisGelSatu> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Pendaftaran Gelombang 1"),
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          ElevatedButton(
            onPressed: () {
              _simpandata();
              navToDaftarYudisGelSatuPage(context);
            },
