...
class DaftarYudisDua extends StatefulWidget {
  const DaftarYudisDua({Key? key}) : super(key: key);

  @override
  _DaftarYudisDuaState createState() => _DaftarYudisDuaState();
}

class _DaftarYudisDuaState extends State<DaftarYudisDua> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Upload File - Gelombang 2'),
  ...
  void _saveFileToFirestore() async {
    try {
      ...
      String buktiBayar = 'gelombang2/$uid/buktibayar.pdf';
      String iuran = 'gelombang2/$uid/Iuran.pdf';
      String buktiSidang = 'gelombang2/$uid/buktisidang.pdf';
      String poto = 'gelombang2/$uid/paspoto.jpg';
