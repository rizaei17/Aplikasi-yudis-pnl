...
class SyaratPendaftaranContent extends StatelessWidget {
  const SyaratPendaftaranContent({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Syarat Pendaftaran'),
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildRichText(
              'Telah Menyelesaikan Semua Mata Kuliah yang Diperlukan: Biasanya, Anda harus telah menyelesaikan semua mata kuliah yang diperlukan dan mata kuliah pilihan yang ditetapkan dalam kurikulum program studi Anda.',
            ),
            _buildRichText(
